...
type Response struct {
	...
	// If the transport is async or waits for a response, examples:
	// transport MQTT: isAsync will be true and empty response.
	// transport HTTP: isAsync will be false and response will be filled.
	Isasync bool `protobuf:"varint,1,opt,name=isasync,proto3" json:"isasync,omitempty"`
	// The status_code returned by the Transport, default 200
	StatusCode int32 `protobuf:"varint,2,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`
	// The body of the response
	Body []byte `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`
	// The mestadata for the request, all the headers in case of HTTP
...
var file_protocol_yggdrasil_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x22, 0xd5, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x18, 0x0a, 0x07, 0x69, 0x73, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x69, 0x73, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x61,
	...
	0x64, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x3d,
	0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x21, 0x2e, 0x79, 0x67, 0x67, 0x64, 0x72, 0x61, 0x73, 0x69, 0x6c, 0x2e, 0x52, 0x65, 0x73,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x61, 0x0a, 0x05, 0x45, 0x76,
...
var file_protocol_yggdrasil_proto_goTypes = []interface{}{
	...
	(*Response)(nil),             // 9: yggdrasil.Response
	nil,                          // 10: yggdrasil.RegistrationRequest.FeaturesEntry
	nil,                          // 11: yggdrasil.Data.MetadataEntry
	nil,                          // 12: yggdrasil.EventNotification.MetadataEntry
	nil,                          // 13: yggdrasil.Response.MetadataEntry
}
var file_protocol_yggdrasil_proto_depIdxs = []int32{
	10, // 0: yggdrasil.RegistrationRequest.features:type_name -> yggdrasil.RegistrationRequest.FeaturesEntry
	11, // 1: yggdrasil.Data.metadata:type_name -> yggdrasil.Data.MetadataEntry
	0,  // 2: yggdrasil.EventNotification.name:type_name -> yggdrasil.Event
	12, // 3: yggdrasil.EventNotification.metadata:type_name -> yggdrasil.EventNotification.MetadataEntry
	13, // 4: yggdrasil.Response.metadata:type_name -> yggdrasil.Response.MetadataEntry
	2,  // 5: yggdrasil.Dispatcher.Register:input_type -> yggdrasil.RegistrationRequest
	4,  // 6: yggdrasil.Dispatcher.Send:input_type -> yggdrasil.Data
	1,  // 7: yggdrasil.Dispatcher.GetConfig:input_type -> yggdrasil.Empty
	4,  // 8: yggdrasil.Worker.Send:input_type -> yggdrasil.Data
	7,  // 9: yggdrasil.Worker.NotifyEvent:input_type -> yggdrasil.EventNotification
	3,  // 10: yggdrasil.Dispatcher.Register:output_type -> yggdrasil.RegistrationResponse
	9,  // 11: yggdrasil.Dispatcher.Send:output_type -> yggdrasil.Response
	8,  // 12: yggdrasil.Dispatcher.GetConfig:output_type -> yggdrasil.Config
	5,  // 13: yggdrasil.Worker.Send:output_type -> yggdrasil.Receipt
	6,  // 14: yggdrasil.Worker.NotifyEvent:output_type -> yggdrasil.EventReceipt
