...
func (c *Client) SendDataMessage(msg *yggdrasil.Data) (*yggdrasil.TransportResponse, error) {
	return c.sendMessage(msg, "data")
}

func (c *Client) SendConnectionStatusMessage(msg *yggdrasil.ConnectionStatus) (*yggdrasil.TransportResponse, error) {
	return c.sendMessage(msg, "control")
}

func (c *Client) SendEventMessage(msg *yggdrasil.Event) (*yggdrasil.TransportResponse, error) {
	return c.sendMessage(msg, "control")
}

func (c *Client) sendMessage(msg interface{}, dest string) (*yggdrasil.TransportResponse, error) {
...
func (c *Client) ReceiveData() {
	for msg := range c.d.recvQ {
		...
		go func(msg yggdrasil.DataMessage) { msg.Response <- res }(msg)
	}
}
