...
func (c *Client) Get(url string) (*yggdrasil.TransportResponse, error) {
...
func (c *Client) Post(url string, headers map[string]string, body []byte) (*yggdrasil.TransportResponse, error) {
...
func createResponse(resp *http.Response) (*yggdrasil.TransportResponse, error) {
	result := &yggdrasil.TransportResponse{
